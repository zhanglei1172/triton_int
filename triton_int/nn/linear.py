...
class W8A8B8O8Linear(torch.nn.Module):
    ...
    def __init__(self, in_features, out_features, alpha=1.0, beta=1.0):
        ...
        self.register_buffer(
            "bias",
            torch.zeros((self.out_features), dtype=torch.int8, requires_grad=False),
        )
...
class W8A8B32O32LinearWithoutScaling(torch.nn.Module):
    ...
    def __init__(self, in_features, out_features):
        ...
        self.register_buffer(
            "bias",
            torch.zeros((self.out_features), dtype=torch.int32, requires_grad=False),
        )
...
class DanymicW8A8BFP32OFP32Linear(torch.nn.Module):
    # For fc2 and out_proj
    def __init__(self, in_features, out_features, alpha=1.0, beta=1.0):
        super().__init__()
        self.in_features = in_features
    ...
    def from_float(module: torch.nn.Linear):
        int8_module = DanymicW8A8BFP32OFP32Linear(
