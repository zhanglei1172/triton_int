...
class BMM_S8T_S8N_S8T(torch.nn.Module):
    ...
    def forward(self, a, b):
        ...
        # b: [B, N, K] int8
        # return: [B, M, N] int8
        return bmm_s8t_s8n_s8t(a, b, self.a)
...
class BMM_S8T_S8T_S8T(torch.nn.Module):
    ...
    def forward(self, a, b):
        ...
        # b: [B, N, K] int8
        # return: [B, M, N] int8
        return bmm_s8t_s8t_s8t(a, b, self.a)
...
class BMM_S8T_S8N_F32T(torch.nn.Module):
    ...
    def forward(self, a, b):
        ...
        # b: [B, N, K] int8
        # return: [B, M, N] int32
        return bmm_s8t_s8n_f32t(a, b, self.a, dtype=self.dtype)
...
class BMM_S8T_S8N_F16T(torch.nn.Module):
    ...
    def forward(self, a, b):
        ...
        # b: [B, N, K] int8
        # return: [B, M, N] int32
        return bmm_s8t_s8n_f32t(a, b, self.a, dtype=torch.float16)
...
class BMM_S8T_S8N_BF16T(torch.nn.Module):
    ...
    def forward(self, a, b):
        ...
        # b: [B, N, K] int8
        # return: [B, M, N] int32
        return bmm_s8t_s8n_f32t(a, b, self.a, dtype=torch.bfloat16)
